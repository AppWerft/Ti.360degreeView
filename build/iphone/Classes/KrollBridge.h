...
@interface Ti360ViewObject : KrollCoverageObject {
#else
@interface Ti360ViewObject : KrollObject {
#endif
@private
...
extern NSString * Ti360View$ModuleRequireFormat;
