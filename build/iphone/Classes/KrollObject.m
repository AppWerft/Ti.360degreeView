...
//@interface Ti360ViewObject : NSObject
//@end

@interface Ti360ViewObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Ti360ViewObject class]])
		{
			for (NSString *key in [[(Ti360ViewObject*)o modules] allKeys])
			{
