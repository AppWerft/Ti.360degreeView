...
// in simulator we redefine to format for Ti360View Developer console
...
{\
	NSString * exceptionName = [@"org.ti360view." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ti360view";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITi360ViewNativeItemNone = -1, 
	UITi360ViewNativeItemSpinner = -2,
	UITi360ViewNativeItemProgressBar = -3,
	
	UITi360ViewNativeItemSlider = -4,
	UITi360ViewNativeItemSwitch = -5,
	UITi360ViewNativeItemMultiButton = -6,
	UITi360ViewNativeItemSegmented = -7,
	
	UITi360ViewNativeItemTextView = -8,
	UITi360ViewNativeItemTextField = -9,
	UITi360ViewNativeItemSearchBar = -10,
	
	UITi360ViewNativeItemPicker = -11,
	UITi360ViewNativeItemDatePicker = -12,
	
	UITi360ViewNativeItemInfoLight = -13,
	UITi360ViewNativeItemInfoDark = -14,
	
	UITi360ViewNativeItemDisclosure = -15,
	
	UITi360ViewNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Ti360View instances of
