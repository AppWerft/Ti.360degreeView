...
/**
 The base class for all Ti360View modules
 */
...
/**
 Ti360View Platform calls this method on startup.
 */
-(void)startup;

/**
 Ti360View Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Ti360View Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Ti360View Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Ti360View Platform calls this method on resume.
 @param sender The sender of the event.
 */
