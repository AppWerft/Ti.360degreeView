...
/**
 Base class for all Ti360View views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Ti360View view hierarchy (such as wrapped iOS UIViews) was touched.
